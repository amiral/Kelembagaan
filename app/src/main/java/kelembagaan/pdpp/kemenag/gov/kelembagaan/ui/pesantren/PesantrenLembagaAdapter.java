...
public class PesantrenLembagaAdapter extends BaseAdapter {

    private Context mContext;
    private LayoutInflater mInflater;
    private List<Lembaga> mDataSource;

    public PesantrenLembagaAdapter(Context mContext, List<Lembaga> mDataSource) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view != null) {
            ...
            view = mInflater.inflate(R.layout.item_madrasah_pesantren, parent, false);
